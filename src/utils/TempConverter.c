...
static void activate(GtkApplication *app, gpointer user_data) {
    GtkWidget *window = create_standard_window(app, "Temperature converter", 300, -1);
    ...
    const char *options[] = {"Celcius → Fahrenheit", "Fahrenheit → Celcius", NULL};
...
int main(int argc, char **argv) {
    GtkApplication *app = gtk_application_new("companion.virus.temp_converter", G_APPLICATION_FLAGS_NONE);
