...
void file_hasher_ui_activate(GtkApplication *app, gpointer user_data) {
...
int main(int argc, char **argv) {
    ...
    g_signal_connect(app, "activate", G_CALLBACK(file_hasher_ui_activate),
                     NULL);
