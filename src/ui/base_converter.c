...
#include "ui/base_converter_ui.h"
...
void base_converter_ui_activate(GtkApplication *app, gpointer user_data) {
...
int main(int argc, char **argv) {
    ...
    g_signal_connect(app, "activate", G_CALLBACK(base_converter_ui_activate),
                     NULL);
